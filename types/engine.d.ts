/** Client-side Engine API, provided to a client app's render() and event handlers. */
...
export interface RenderContext {
  ...
  /** WebGL or WebGPU context (whichever the running renderer backend uses). */
  ...
  /** The player currently being viewed, which is not always `localPlayer` (e.g. spectator mode). */
...
/** Shape of the global app context available at runtime on `window.__app`. */
