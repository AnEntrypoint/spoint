...
export function createLoaders(renderer) {
  ...
  dracoLoader.setDecoderPath('/spoint/draco/'); dracoLoader.setWorkerLimit(4); dracoLoader.preload()
  gltfLoader.setDRACOLoader(dracoLoader)
  gltfLoader.setMeshoptDecoder(MeshoptDecoder)
  gltfLoader.register((parser) => new VRMLoaderPlugin(parser))
  const ktx2Loader = new KTX2Loader(loadingManager)
  ktx2Loader.setTranscoderPath('/spoint/basis/'); ktx2Loader.detectSupport(renderer)
