export default {
  description: 'Dynamic box: a physics-simulated crate with configurable size, mass, colour and roughness.',
  server: {
    editorProps: [
    ...
    setup(ctx) {
      ...
      ctx.physics.addColliderFromConfig({ type: 'box', size: [hx, hy, hz], mass: c.mass ?? 50, dynamic: true, ccd: c.ccd ?? 'auto' })
    }
  }
}
