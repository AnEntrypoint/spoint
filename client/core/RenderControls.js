const CONTROLS = [
  ...
  { key: 'seaLevelY', group: 'water', type: 'number', default: null,
    doc: 'World-space sea-level Y (metres), written by UnderwaterTint.setSeaLevelY at terrain-ready into the shared spointSea uniform (sea Y at the anchor, planet radius, enabled; spointSeaShift carries the floating-origin shift) that every patched material and SSR read through spointSeaSurfaceY, the exact water sphere. Drives the below-water tint threshold and the SSR sea band.' },
