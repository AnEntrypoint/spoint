...
function loadEntityModel(entityId, entityState) {
  ...
  gltfLoader.load(url, (gltf) => {
    ...
    model.traverse(c => { if (c.isMesh) { c.castShadow = true; c.receiveShadow = true; if (c.material) { c.material.shadowSide = THREE.FrontSide; c.material.roughness = 1; c.material.metalness = 0; if (c.material.specularIntensity !== undefined) c.material.specularIntensity = 0 } } })
    scene.add(model)
